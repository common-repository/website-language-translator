<?php
/*
Plugin Name: Website Language Translator
Plugin URI: https://ziscom.today/website-language-translator/
Version: 10.0.0
Description: Website Translator plugin adds Google Translator floating button, Ready to use, to your website, after Installation. You may also use shortcode [google-translator]. 
Author: Ziscom
...
class google_language_translator {
  ...
  public function glt_settings_link ( $links ) {
    $settings_link = array(
      '<a href="' . admin_url( 'options-general.php?page=website_language_translator' ) . '">Settings</a>',
    );
   return array_merge( $links, $settings_link );
  }

  public function add_my_admin_menus(){
    $p = add_options_page('Website Language Translator', 'Website Language Translator', 'manage_options', 'website_language_translator', array(&$this, 'page_layout_cb'));
  ...
  public function flags() {
    ...
    wp_enqueue_script( 'scripts-google', '//translate.google.com/translate_a/element.js?cb=GoogleLanguageTranslatorInit', array('jquery'), null, true);
    wp_enqueue_style( 'website-language-translator', plugins_url('css/style.css', __FILE__), '', PLUGIN_VER, '');
...
$('.languages').find('input:checkbox').prop('checked', false); }); }); </script>
  ...
  public function page_layout_cb() {
    include( plugin_dir_path( __FILE__ ) . '/css/style.php'); add_thickbox(); ?>
      ...
      <h2><span class="notranslate">Website Language Translator</span></h2>
                  ...
                  <h3 class="notranslate">Main Settings</h3>
                    <?php settings_fields('google_language_translator'); ?>
                      <table style="border-collapse:separate" width="100%" border="0" cellspacing="8" cellpadding="0" class="form-table">
						...
						<tr class="buy pro">
						  <td colspan="2">Free version allow only two languages translations. <a href ="https://ziscom.today/product/website-language-translator/">Buy Pro Version</a> for 100+ language translations. Visit https://ziscom.today/product/website-language-translator/ to get detailed information of languages supported.</td>
						</tr>
...
class GLT_Notices {
    ...
    public function glt_admin_notices() {
        ...
        foreach($deactivate_plugins as $name => $plugin_file) {
            if(is_plugin_active($plugin_file)) {
                ...
                $notices['deactivate_plugin_'.strtolower(str_replace(' ', '', $name))] = array(
                    ...
                    'msg' => sprintf(__('%s plugin causes conflicts with Website Language Translator.', 'glt'), $name),
        ...
        $notices['glt_announcement'] = array(
            'title' => __('Announcement - Website Language Translator', 'glt'),
            'msg' => __("<p><b>Website Language Translator</b> plugin is now a part of <b>Ziscom</b> family!</p> <p>Ziscom is a leader in website translation technology. You can continue using this plugin brought to you by Ziscom.</p>", 'glt'),
            'link' => '<li><span class="dashicons dashicons-admin-settings"></span><a href="' . admin_url('options-general.php?page=google_language_translator') . '">' . __('Open Settings Page', 'glt') . '</a></li>' .
        ...
        $notices['two_week_review'] = array(
            ...
            'msg' => __("We hope you have enjoyed using Website Language Translator! Would you mind taking a few minutes to write a review on WordPress.org? <br>Just writing a simple <b>'thank you'</b> will make us happy!", 'glt'),
            'link' => '<li><span class="dashicons dashicons-external"></span><a href="https://wordpress.org/support/plugin/website-language-translator/reviews/?filter=5" target="_blank">' . __('Sure! I would love to!', 'glt') . '</a></li>' .
        ...
        if(get_option('googlelanguagetranslator_seo_active') != '1') {
            $notices['upgrade_tips'][] = array(
                ...
                'msg' => __('You can have <b>neural machine translations</b> which are human level with Ziscom paid version.', 'glt'),
                'link' => '<li><span class="dashicons dashicons-external"></span><a href="https://ziscom.today/product/website-language-translator" target="_blank">' . __('Learn more', 'glt') . '</a></li>' .
            ...
            $notices['upgrade_tips'][] = array(
                'title' => __('Did you know?', 'glt'),
                'msg' => __('You can <b>increase</b> your international <b>traffic</b> with Ziscom paid version.', 'glt'),
                'link' => '<li><span class="dashicons dashicons-external"></span><a href="https://ziscom.today/product/website-language-translator" target="_blank">' . __('Learn more', 'glt') . '</a></li>' .
                          '<li><span class="dashicons dashicons-calendar-alt"></span><a href="' . $upgrade_tips_temp . '">' . __('Maybe later', 'glt') . '</a></li>' .
                          '<li><span class="dashicons dashicons-dismiss"></span><a href="' . $upgrade_tips_ignore . '">' . __('Never show again', 'glt') . '</a></li>',
                'later_link' => $upgrade_tips_temp,
            ...
            $notices['upgrade_tips'][] = array(
                'title' => __('Did you know?', 'glt'),
                'msg' => __('You can have your <b>translated pages indexed</b> in search engines with Ziscom paid version.', 'glt'),
                'link' => '<li><span class="dashicons dashicons-external"></span><a href="https://ziscom.today/product/website-language-translator" target="_blank">' . __('Learn more', 'glt') . '</a></li>' .
                          '<li><span class="dashicons dashicons-calendar-alt"></span><a href="' . $upgrade_tips_temp . '">' . __('Maybe later', 'glt') . '</a></li>' .
                          '<li><span class="dashicons dashicons-dismiss"></span><a href="' . $upgrade_tips_ignore . '">' . __('Never show again', 'glt') . '</a></li>',
                'later_link' => $upgrade_tips_temp,
            ...
            $notices['upgrade_tips'][] = array(
                'title' => __('Did you know?', 'glt'),
                'msg' => __('You can <b>increase</b> your <b>AdSense revenue</b> with Ziscom paid version.', 'glt'),
                'link' => '<li><span class="dashicons dashicons-external"></span><a href="https://ziscom.today/product/website-language-translator" target="_blank">' . __('Learn more', 'glt') . '</a></li>' .
                          '<li><span class="dashicons dashicons-calendar-alt"></span><a href="' . $upgrade_tips_temp . '">' . __('Maybe later', 'glt') . '</a></li>' .
                          '<li><span class="dashicons dashicons-dismiss"></span><a href="' . $upgrade_tips_ignore . '">' . __('Never show again', 'glt') . '</a></li>',
                'later_link' => $upgrade_tips_temp,
            ...
            $notices['upgrade_tips'][] = array(
                'title' => __('Did you know?', 'glt'),
                'msg' => __('You can <b>edit translations</b> with Ziscom paid version.', 'glt'),
                'link' => '<li><span class="dashicons dashicons-external"></span><a href="https://ziscom.today/product/website-language-translator" target="_blank">' . __('Learn more', 'glt') . '</a></li>' .
                          '<li><span class="dashicons dashicons-calendar-alt"></span><a href="' . $upgrade_tips_temp . '">' . __('Maybe later', 'glt') . '</a></li>' .
                          '<li><span class="dashicons dashicons-dismiss"></span><a href="' . $upgrade_tips_ignore . '">' . __('Never show again', 'glt') . '</a></li>',
                'later_link' => $upgrade_tips_temp,
...
if($glt_seo_active == '1' and $glt_url_structure == 'sub_directory') { // Ziscom redirect rules with PHP (for environments with no .htaccess support (pantheon, flywheel, etc.), usually .htaccess rules override this)
    ...
    if(get_option('googlelanguagetranslator_seo_active') == '1' and get_option('googlelanguagetranslator_url_structure') == 'sub_directory') { // check if rewrite rules are in place
        ...
        if(is_writeable($htaccess_file)) {
            ...
            if(strpos($htaccess, 'gtranslate.php') === false) { // no config rules
                ...
                $rewrite_rules = str_replace('GLT_PLUGIN_PATH', str_replace(str_replace(array('https:', 'http:'), array(':', ':'), home_url()), '', str_replace(array('https:', 'http:'), array(':', ':'), plugins_url())) . '/website-language-translator', $rewrite_rules);
            ...
            $rewrite_rules = file_get_contents(dirname(__FILE__) . '/url_addon/rewrite.txt');
            $rewrite_rules = str_replace('GLT_PLUGIN_PATH', str_replace(home_url(), '', plugins_url()) . '/website-language-translator', $rewrite_rules);
        ...
        if(is_writable($config_file)) {
            ...
            add_settings_error(
                'glt_settings_notices',
                esc_attr( 'settings_updated' ),
                '<p style="color:red;">' . __('Cannot update website-language-translator/url_addon/config.php file. Make sure to update it manually and set correct $main_lang.', 'glt') . '</p>',
                'error'
            );
        }
...
add_filter( 'site_transient_update_plugins', 'notification' );
